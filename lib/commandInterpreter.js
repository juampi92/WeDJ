		...
		// Library
			...
			case "addlib":
				...
				_this.lib.addFolder([ args ]);				
					...
					else return _this.lang.trans("lib.added",args);
				break;
			case "addlibexc":
				if ( args == null ) { return (_this.lang.get("lib.error.nullInput")).red; break;}
				_this.lib.addExclude( args );				
					if ( debug ) return _this.lib.excluded;
					else return _this.lang.trans("lib.excluded",args);				
				break;
			case "rmlib":
				if ( args == null ) { return (_this.lang.get("lib.error.nullInput")).red; break;}
				_this.lib.rmFolder(args);				
					if ( debug ) return _this.lib.folders;
					return _this.lang.trans("lib.removed",args);				
				break;
			case "rmlibexc":
				if ( args == null ) { return (_this.lang.get("lib.error.nullInput")).red; break;}
				_this.lib.rmExclude(args);
					if ( debug ) return _this.lib.excluded;
					return _this.lang.trans("lib.unexcluded",args);				
				break;
			case "showlibs":
